...
<html>
    ...
    <body onload="cargarMaterialesAdmin()">
                        ...
                        <div>
                            <div class="row">
                                <div class="col-xl-8 col-lg-8 col-md-9 col-sm-9">
                                    ...
                                    <select id='cambiar-admin' class='btn-select-color btn cambiar-admin' onchange='cambiarVistaAdminCatyMat()'><option value='1'>Categorias</option><option selected value='2'>Materiales</option></select>
                                </div>
                            </div>
                            <div id="tabla-admin">
